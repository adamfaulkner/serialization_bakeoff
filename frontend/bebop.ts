...
export const bebop: Deserializer<IServerResponseAll> = {
	...
	materializeUnverifiedAsPojo: (deserialized: IServerResponseAll): ServerResponseAll => {
	...
	materializeVerifedAsPojo: function (deserialized: IServerResponseAll): ServerResponseAll {
		...
		for (const trip of deserialized.trips) {
			...
			if (trip.rideableType === undefined || trip.rideableType === RideableType.Unknown) {
			...
			if (trip.memberCasual === undefined || trip.memberCasual === MemberCasual.Unknown) {
