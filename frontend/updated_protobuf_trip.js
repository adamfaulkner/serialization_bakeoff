// This is exactly the same as protobuf_trip.js except that I substituted my hacked version of the protobuf library for this import.

import * as $protobuf from "updated_protobufjs/minimal";
...
export const trip_protobuf = $root.trip_protobuf = (() => {
     ...
     */
    trip_protobuf.RideableType = (function() {
     ...
     */
    trip_protobuf.MemberCasual = (function() {
        const valuesById = {}, values = Object.create(valuesById);
    ...
    trip_protobuf.Trip = (function() {
        ...
        Trip.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.trip_protobuf.Trip();
        ...
        Trip.verify = function verify(message) {
            ...
            if (message.endedAtMs != null && message.hasOwnProperty("endedAtMs"))
                if (!$util.isInteger(message.endedAtMs) && !(message.endedAtMs && $util.isInteger(message.endedAtMs.low) && $util.isInteger(message.endedAtMs.high)))
            ...
            if (message.startStationName != null && message.hasOwnProperty("startStationName")) {
                ...
                if (!$util.isString(message.startStationName))
                    return "startStationName: string expected";
            }
            if (message.startStationId != null && message.hasOwnProperty("startStationId")) {
                properties._startStationId = 1;
                if (!$util.isString(message.startStationId))
                    return "startStationId: string expected";
            }
            if (message.endStationName != null && message.hasOwnProperty("endStationName")) {
                properties._endStationName = 1;
                if (!$util.isString(message.endStationName))
                    return "endStationName: string expected";
            }
            if (message.endStationId != null && message.hasOwnProperty("endStationId")) {
                properties._endStationId = 1;
                if (!$util.isString(message.endStationId))
                    return "endStationId: string expected";
            }
        ...
        Trip.fromObject = function fromObject(object) {
            if (object instanceof $root.trip_protobuf.Trip)
                return object;
            let message = new $root.trip_protobuf.Trip();
            ...
            if (object.endedAtMs != null)
                if ($util.Long)
                    (message.endedAtMs = $util.Long.fromValue(object.endedAtMs)).unsigned = false;
                else if (typeof object.endedAtMs === "string")
                    message.endedAtMs = parseInt(object.endedAtMs, 10);
                else if (typeof object.endedAtMs === "number")
                    message.endedAtMs = object.endedAtMs;
            ...
            if (object.startStationName != null)
                message.startStationName = String(object.startStationName);
            if (object.startStationId != null)
                message.startStationId = String(object.startStationId);
            if (object.endStationName != null)
                message.endStationName = String(object.endStationName);
            if (object.endStationId != null)
                message.endStationId = String(object.endStationId);
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (message.rideableType != null && message.hasOwnProperty("rideableType"))
                object.rideableType = options.enums === String ? $root.trip_protobuf.RideableType[message.rideableType] === undefined ? message.rideableType : $root.trip_protobuf.RideableType[message.rideableType] : message.rideableType;
            if (message.startedAtMs != null && message.hasOwnProperty("startedAtMs"))
            ...
            if (message.endedAtMs != null && message.hasOwnProperty("endedAtMs"))
                if (typeof message.endedAtMs === "number")
                    ...
                    object.endedAtMs = options.longs === String ? $util.Long.prototype.toString.call(message.endedAtMs) : options.longs === Number ? new $util.LongBits(message.endedAtMs.low >>> 0, message.endedAtMs.high >>> 0).toNumber() : message.endedAtMs;
            if (message.startStationName != null && message.hasOwnProperty("startStationName")) {
                object.startStationName = message.startStationName;
                if (options.oneofs)
                    object._startStationName = "startStationName";
            }
            if (message.startStationId != null && message.hasOwnProperty("startStationId")) {
                object.startStationId = message.startStationId;
                if (options.oneofs)
                    object._startStationId = "startStationId";
            }
            if (message.endStationName != null && message.hasOwnProperty("endStationName")) {
                object.endStationName = message.endStationName;
                if (options.oneofs)
                    object._endStationName = "endStationName";
            }
            if (message.endStationId != null && message.hasOwnProperty("endStationId")) {
                object.endStationId = message.endStationId;
                if (options.oneofs)
                    object._endStationId = "endStationId";
            }
            if (message.startLat != null && message.hasOwnProperty("startLat")) {
                object.startLat = options.json && !isFinite(message.startLat) ? String(message.startLat) : message.startLat;
                if (options.oneofs)
                    object._startLat = "startLat";
            }
            if (message.startLng != null && message.hasOwnProperty("startLng")) {
                object.startLng = options.json && !isFinite(message.startLng) ? String(message.startLng) : message.startLng;
                if (options.oneofs)
                    object._startLng = "startLng";
            }
            if (message.endLat != null && message.hasOwnProperty("endLat")) {
                object.endLat = options.json && !isFinite(message.endLat) ? String(message.endLat) : message.endLat;
                if (options.oneofs)
                    object._endLat = "endLat";
            }
            if (message.endLng != null && message.hasOwnProperty("endLng")) {
                object.endLng = options.json && !isFinite(message.endLng) ? String(message.endLng) : message.endLng;
                if (options.oneofs)
                    object._endLng = "endLng";
            }
            if (message.memberCasual != null && message.hasOwnProperty("memberCasual"))
                object.memberCasual = options.enums === String ? $root.trip_protobuf.MemberCasual[message.memberCasual] === undefined ? message.memberCasual : $root.trip_protobuf.MemberCasual[message.memberCasual] : message.memberCasual;
            return object;
        };
    ...
    trip_protobuf.ServerResponseAll = (function() {
        ...
        ServerResponseAll.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.trip_protobuf.ServerResponseAll();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        ServerResponseAll.verify = function verify(message) {
            ...
            if (message.trips != null && message.hasOwnProperty("trips")) {
                ...
                for (let i = 0; i < message.trips.length; ++i) {
                    let error = $root.trip_protobuf.Trip.verify(message.trips[i]);
                    if (error)
                        return "trips." + error;
                }
            }
        ...
        ServerResponseAll.fromObject = function fromObject(object) {
            if (object instanceof $root.trip_protobuf.ServerResponseAll)
                return object;
            let message = new $root.trip_protobuf.ServerResponseAll();
            if (object.trips) {
                if (!Array.isArray(object.trips))
                    throw TypeError(".trip_protobuf.ServerResponseAll.trips: array expected");
                message.trips = [];
