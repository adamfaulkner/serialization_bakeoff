...
import { Trip } from "../flatbuffers/trip.js";
...
export class ServerResponseAll {
  ...
  static getRootAsServerResponseAll(
  ...
  static createServerResponseAll(
    builder: flatbuffers.Builder,
    tripsOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {
