...
const ajv = new Ajv();
export const serverResponseAllAjvValidator = ajv.compile(serverResponseAllJtdSchema);
...
export const serverResponseAllReceivedAjvValidator = ajv.compile(serverResponseAllReceivedJsonAjvSchema);
