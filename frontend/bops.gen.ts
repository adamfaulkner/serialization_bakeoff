...
// </auto-generated>
import { BebopJson, type BebopRecord, BebopRuntimeError, BebopTypeGuard, BebopView, Guid, GuidMap } from "bebop";

export const BEBOP_SCHEMA = new Uint8Array([
	3, 4, 0, 0, 0, 82, 105, 100, 101, 97, 98, 108, 101, 84, 121, 112, 101, 0, 4, 0, 251, 255, 255, 255, 0, 4, 0, 0, 0, 3,
	85, 78, 75, 78, 79, 87, 78, 0, 0, 0, 0, 0, 0, 66, 73, 67, 89, 67, 76, 69, 0, 0, 1, 0, 0, 0, 69, 66, 73, 67, 89, 67,
	76, 69, 0, 0, 2, 0, 0, 0, 77, 101, 109, 98, 101, 114, 67, 97, 115, 117, 97, 108, 0, 4, 0, 251, 255, 255, 255, 0, 4, 0,
	0, 0, 3, 85, 78, 75, 78, 79, 87, 78, 0, 0, 0, 0, 0, 0, 77, 69, 77, 66, 69, 82, 0, 0, 1, 0, 0, 0, 67, 65, 83, 85, 65,
	76, 0, 0, 2, 0, 0, 0, 84, 114, 105, 112, 0, 2, 0, 5, 0, 0, 0, 13, 114, 105, 100, 101, 95, 105, 100, 0, 245, 255, 255,
	255, 0, 1, 114, 105, 100, 101, 97, 98, 108, 101, 95, 116, 121, 112, 101, 0, 0, 0, 0, 0, 0, 2, 115, 116, 97, 114, 116,
	101, 100, 95, 97, 116, 0, 243, 255, 255, 255, 0, 3, 101, 110, 100, 101, 100, 95, 97, 116, 0, 243, 255, 255, 255, 0, 4,
	115, 116, 97, 114, 116, 95, 115, 116, 97, 116, 105, 111, 110, 95, 110, 97, 109, 101, 0, 245, 255, 255, 255, 0, 5, 115,
	116, 97, 114, 116, 95, 115, 116, 97, 116, 105, 111, 110, 95, 105, 100, 0, 245, 255, 255, 255, 0, 6, 101, 110, 100, 95,
	115, 116, 97, 116, 105, 111, 110, 95, 110, 97, 109, 101, 0, 245, 255, 255, 255, 0, 7, 101, 110, 100, 95, 115, 116, 97,
	116, 105, 111, 110, 95, 105, 100, 0, 245, 255, 255, 255, 0, 8, 115, 116, 97, 114, 116, 95, 108, 97, 116, 0, 246, 255,
	255, 255, 0, 9, 115, 116, 97, 114, 116, 95, 108, 110, 103, 0, 246, 255, 255, 255, 0, 10, 101, 110, 100, 95, 108, 97,
	116, 0, 246, 255, 255, 255, 0, 11, 101, 110, 100, 95, 108, 110, 103, 0, 246, 255, 255, 255, 0, 12, 109, 101, 109, 98,
	101, 114, 95, 99, 97, 115, 117, 97, 108, 0, 1, 0, 0, 0, 0, 13, 83, 101, 114, 118, 101, 114, 82, 101, 115, 112, 111,
	110, 115, 101, 65, 108, 108, 0, 2, 0, 5, 0, 0, 0, 1, 116, 114, 105, 112, 115, 0, 242, 255, 255, 255, 0, 2, 0, 0, 0, 0,
	1, 0, 0, 0, 0,
]);
...
export class ServerResponseAll implements IServerResponseAll {
	...
	public static readFrom(view: BebopView): IServerResponseAll {
		const message: IServerResponseAll = {};
		const length = view.readMessageLength();
		const end = view.index + length;
		while (true) {
			switch (view.readByte()) {
