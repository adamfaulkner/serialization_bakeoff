...
import { MemberCasual } from "./member-casual.js";
import { RideableType } from "./rideable-type.js";
...
export class Trip {
	...
	static addStartStationName(builder: flatbuffers.Builder, startStationNameOffset: flatbuffers.Offset) {
