...
impl<'a> Trip<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.end_station_id { builder.add_end_station_id(x); }
    if let Some(x) = args.end_station_name { builder.add_end_station_name(x); }
    if let Some(x) = args.start_station_id { builder.add_start_station_id(x); }
    if let Some(x) = args.start_station_name { builder.add_start_station_name(x); }
    if let Some(x) = args.ride_id { builder.add_ride_id(x); }
  ...
  pub fn ride_id(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Trip::VT_RIDE_ID, None)}
  }
  #[inline]
  pub fn rideable_type(&self) -> RideableType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<RideableType>(Trip::VT_RIDEABLE_TYPE, Some(RideableType::UNKNOWN_RIDEABLE_TYPE)).unwrap()}
  }
  #[inline]
  pub fn started_at_ms(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(Trip::VT_STARTED_AT_MS, Some(0)).unwrap()}
  }
  #[inline]
  ...
  pub fn start_station_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Trip::VT_START_STATION_NAME, None)}
  }
  #[inline]
  pub fn start_station_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Trip::VT_START_STATION_ID, None)}
  }
  #[inline]
  pub fn end_station_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Trip::VT_END_STATION_NAME, None)}
  }
  #[inline]
  pub fn end_station_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Trip::VT_END_STATION_ID, None)}
  }
  #[inline]
  ...
  pub fn member_casual(&self) -> MemberCasual {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<MemberCasual>(Trip::VT_MEMBER_CASUAL, Some(MemberCasual::UNKNOWN_MEMBER_CASUAL)).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for Trip<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("ride_id", Self::VT_RIDE_ID, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("start_station_name", Self::VT_START_STATION_NAME, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("start_station_id", Self::VT_START_STATION_ID, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("end_station_name", Self::VT_END_STATION_NAME, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("end_station_id", Self::VT_END_STATION_ID, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TripBuilder<'a, 'b, A> {
  ...
  pub fn add_ride_id(&mut self, ride_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Trip::VT_RIDE_ID, ride_id);
  }
  #[inline]
  pub fn add_rideable_type(&mut self, rideable_type: RideableType) {
    self.fbb_.push_slot::<RideableType>(Trip::VT_RIDEABLE_TYPE, rideable_type, RideableType::UNKNOWN_RIDEABLE_TYPE);
  }
  #[inline]
  pub fn add_started_at_ms(&mut self, started_at_ms: i64) {
    self.fbb_.push_slot::<i64>(Trip::VT_STARTED_AT_MS, started_at_ms, 0);
  }
  #[inline]
  pub fn add_ended_at_ms(&mut self, ended_at_ms: i64) {
    self.fbb_.push_slot::<i64>(Trip::VT_ENDED_AT_MS, ended_at_ms, 0);
  }
  #[inline]
  pub fn add_start_station_name(&mut self, start_station_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Trip::VT_START_STATION_NAME, start_station_name);
  }
  #[inline]
  pub fn add_start_station_id(&mut self, start_station_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Trip::VT_START_STATION_ID, start_station_id);
  }
  #[inline]
  pub fn add_end_station_name(&mut self, end_station_name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Trip::VT_END_STATION_NAME, end_station_name);
  }
  #[inline]
  pub fn add_end_station_id(&mut self, end_station_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Trip::VT_END_STATION_ID, end_station_id);
  }
  #[inline]
  pub fn add_start_lat(&mut self, start_lat: f64) {
    self.fbb_.push_slot::<f64>(Trip::VT_START_LAT, start_lat, 0.0);
  }
  #[inline]
  pub fn add_start_lng(&mut self, start_lng: f64) {
    self.fbb_.push_slot::<f64>(Trip::VT_START_LNG, start_lng, 0.0);
  }
  #[inline]
  ...
  pub fn add_member_casual(&mut self, member_casual: MemberCasual) {
    self.fbb_.push_slot::<MemberCasual>(Trip::VT_MEMBER_CASUAL, member_casual, MemberCasual::UNKNOWN_MEMBER_CASUAL);
  }
  #[inline]
...
impl<'a> ServerResponseAll<'a> {
  ...
  #[inline]
  pub fn trips(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Trip<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Trip>>>>(ServerResponseAll::VT_TRIPS, None)}
  }
}
...
impl flatbuffers::Verifiable for ServerResponseAll<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Trip>>>>("trips", Self::VT_TRIPS, false)?
     .finish();
    Ok(())
  }
}
pub struct ServerResponseAllArgs<'a> {
    pub trips: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Trip<'a>>>>>,
}
impl<'a> Default for ServerResponseAllArgs<'a> {
  #[inline]
  fn default() -> Self {
    ServerResponseAllArgs {
      trips: None,
    }
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ServerResponseAllBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_trips(&mut self, trips: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Trip<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ServerResponseAll::VT_TRIPS, trips);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> ServerResponseAllBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
